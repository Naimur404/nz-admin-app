...
import { DepositItem } from '@/services/deposits';
...
export default function AgentDepositsScreen() {
    ...
    <View style={[styles.container, { backgroundColor: isDark ? '#111827' : '#f5f5f5' }]}>
      ...
      <SafeAreaView style={[styles.safeArea, { backgroundColor: isDark ? '#1f2937' : '#1e40af' }]} edges={['top']}>
        ...
        <View style={[styles.header, { backgroundColor: isDark ? '#1f2937' : '#1e40af' }]}>
          ...
          <Text style={styles.headerTitle}>Agent Deposits</Text>
      ...
      {loading ? (
        <View style={styles.loadingContainer}>
          ...
          <Text style={[styles.loadingText, { color: isDark ? '#9ca3af' : '#6b7280' }]}>
            Loading agent deposits...
          </Text>
        </View>
      ) : deposits.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Ionicons name="document-outline" size={64} color={isDark ? '#4b5563' : '#d1d5db'} />
          <Text style={[styles.emptyTitle, { color: isDark ? '#f3f4f6' : '#4b5563' }]}>No Agent Deposits</Text>
          <Text style={[styles.emptySubtitle, { color: isDark ? '#9ca3af' : '#6b7280' }]}>
            No agent deposits found for the selected criteria.
          </Text>
        </View>
      ) : (
        <FlatList
